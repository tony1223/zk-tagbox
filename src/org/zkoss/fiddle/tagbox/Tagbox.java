...
import org.zkoss.fiddle.tagbox.event.AddTagEvent;
...
public class Tagbox extends XulElement {
	...
	static {
		addClientEvent(Tagbox.class, AddTagEvent.ON_ADD_TAG, CE_IMPORTANT | CE_NON_DEFERRABLE);
	}
	...
	public void service(AuRequest request, boolean everError) {
		if(AddTagEvent.ON_ADD_TAG.equals(request.getCommand())){
			AddTagEvent evt = AddTagEvent.getAddTagEvent(request);
